 ...
 * @since 9.0.0
 */
public class Pac4jReflectionBuilder extends ReflectionBuilder {

    //TODO - complete JavaDoc

    private static final Logger log = LoggerFactory.getLogger(Pac4jReflectionBuilder.class);
    ...
    public Pac4jReflectionBuilder() {
        this(null);
    }

    public Pac4jReflectionBuilder(Map<String, ?> defaults) {
    ...
    private void enableEventsIfNecessary(Object bean, String name) {
        ...
        if (!applied && isEventSubscriber(bean)) {
