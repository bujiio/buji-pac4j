...
public class CallbackFilter implements Filter {
    ...
    private HttpActionAdapter<Object, J2EContext> httpActionAdapter = J2ENopHttpActionAdapter.INSTANCE;
    ...
    public void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse, final FilterChain filterChain) throws IOException, ServletException {
        ...
        callbackLogic.perform(context, config, httpActionAdapter, this.defaultUrl, this.multiProfile, false);
    }
